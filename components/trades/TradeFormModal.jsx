    ...
    <section className="detail-modal trade-form-modal" role="dialog" aria-modal="true" aria-labelledby="trade-form-title">
      ...
      <form onSubmit={submit}>
        <div className="row g-3">
          ...
          <div className="col-12"><span className="form-label">Notification Duration</span><div className="trade-interval-options">{[[1, '1 Min'], [2, '2 Min'], [7, '7 Days'], [14, '14 Days'], [21, '21 Days']].map(([interval, label]) => <label className="form-check form-check-inline" key={interval}><input className="form-check-input" type="checkbox" checked={form.intervals.includes(interval)} onChange={() => toggleInterval(interval)} /><span className="form-check-label">{label}</span></label>)}</div></div>
