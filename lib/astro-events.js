import { astrologyService } from '@/lib/data/services/astrology.service';
import { marketService } from '@/lib/data/services/market.service';
import { masterService } from '@/lib/data/services/master.service';
...
const amavasyaData = astrologyService.getAmavasyaData();
const purnimaData = astrologyService.getPurnimaData();
const marchEquinox = masterService.getMarchEquinoxData();
const bhadraData = astrologyService.getBhadraData();
const panchakData = astrologyService.getPanchakData();
const mangalData = astrologyService.getMangalData();
const shukraData = astrologyService.getShukraData();
const weeklyData = marketService.getWeeklyMarketData();
